...
void forward()
{
 ...
 pwm.setPWM(2, 0, 600);//set pwm signal to BIN2 of DRV8833
 pwm.setPWM(3, 0, -600);//set pwm signal to BIN1 of DRV8833
 //drive M2 Motror forward
 pwm.setPWM(0,0,-600);//set pwm signal to AIN1 of DRV8833
 pwm.setPWM(1,0,600);//set pwm signal to AIN2 of DRV8833
 //drive M3 Motror forward
 pwm.setPWM(6, 0, 600);//set pwm signal to BIN2 of DRV8833
 pwm.setPWM(7, 0, -600);//set pwm signal to BIN1 of DRV8833
 //drive M4 Motror forward
 pwm.setPWM(4, 0, -600);//set pwm signal to AIN1 of DRV8833
 pwm.setPWM(5, 0, 600);//set pwm signal to AIN2 of DRV8833
}
