# CS5, "Sounds Good" lab
#
# Solution Writer: Edited by Trevor Fung Summer 2016
# Problem description: Sound lab

# csaudio.py
# import csaudio ; reload(csaudio) ; from csaudio import *

# """
# Notes for when this program breaks:
#  - This program is first called by the hw3pr1 file to run play(filename).
#  - The next call is to read_wav(filename), which in turn calls:
...
#  - Next call is to write_wav(sound_data, desired filename), which in turn calls:
#     - tri(params, data), which converts the float list into a bunch of bytes
#     - write_wav(params, rawframesstring, filename) which takes in all the bytes
#        and converts it to a sound file
# """
