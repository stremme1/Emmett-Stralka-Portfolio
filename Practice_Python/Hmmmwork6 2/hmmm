#!/usr/bin/python3
#
# $Id: hmmm,v 2.7 2021-01-19 17:04:08-08 geoff Exp $
#
...
def debugMode():
    ...
    translation, opcode, args = disassemble(memory[lastPC])
    print("\nProgram Counter:", lastPC)
    print("Next Instruction to Execute:", translation)
    if not ask:
        return
    while True:
...
# $Log: hmmm,v $
# Revision 2.7  2021-01-19 17:04:08-08  geoff
# Fix an error message that gave the wrong PC
#
# Revision 2.6  2021-01-19 17:00:31-08  geoff
# Clean up the debugger to operate like standard debuggers: the
# instruction shown is the next to be executed, and there is no clutter
